...
let MonadIO = MkMonad bind return in
let return_ = \x->Nil in
let bind_ = \x -> \f -> Nil in
let MonadList = MkMonad bind_ return_ in --not a real Monad List, just to test whether typing is correct
...
in runIO (putInt ffi ` 1993 `)--runIO main
